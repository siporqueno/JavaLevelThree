...
public class HomeWorkChecker {
    ...
    public void checkOneHomeWorkFile(String fileNameWithoutDotClass) {
        ...
        try {
            ...
            // call of method void printIsPositive [int]
            ...
            // call of method void printWelocome [class java.lang.String]
            ...
            System.out.println("Something went wrong in the method checkOneHomeWorkFile");
            e.printStackTrace();
        }
    }
}
